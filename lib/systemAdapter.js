...
SystemAdapter.prototype.scheduleNextUpcomingStart = function scheduleNextUpcomingStart(callback) {
	var now = new Date()
		, nextTask = this.schedule.getNextUpcomingTask(now, Task.prototype.START);
...
SystemAdapter.prototype.scheduleNextUpcomingShutdown = function scheduleNextUpcomingShutdown(callback) {
	var now = new Date()
		, nextTask = this.schedule.getNextUpcomingTask(now, Task.prototype.SHUTDOWN);
