 ...
 */
Scheduler.prototype.scheduleNextUpcomingStart = function scheduleNextUpcomingStart(callback) {
  var now = new Date(),
 ...
 *     (Function) callback - called upon completion
 */
Scheduler.prototype.scheduleNextUpcomingShutdown = function scheduleNextUpcomingShutdown(callback) {
  var now = new Date(),
